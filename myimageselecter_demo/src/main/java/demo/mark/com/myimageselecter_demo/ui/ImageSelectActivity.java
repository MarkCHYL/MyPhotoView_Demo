package demo.mark.com.myimageselecter_demo.ui;
...
import demo.mark.com.myimageselecter_demo.R;
import demo.mark.com.myimageselecter_demo.adapter.ImageDirAdapter;
import demo.mark.com.myimageselecter_demo.adapter.MyAdapter;
import demo.mark.com.myimageselecter_demo.adapter.SpacesItemDecoration;
import demo.mark.com.myimageselecter_demo.bean.ImageBean;
import demo.mark.com.myimageselecter_demo.bean.ImageDirBean;
import demo.mark.com.myimageselecter_demo.click.OnChangeListener;
import demo.mark.com.myimageselecter_demo.click.OnImageDirItemListener;
import demo.mark.com.myimageselecter_demo.click.OnItemClickListener;
        ...
        if (position != 0) {
            ...
            if (maxImageCount == 1) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                    Uri imageUri = FileProvider.getUriForFile(ImageSelectActivity.this, "demo.mark.com.myimageselecter_demo.fileprovider", new File(mImages.get(position).getPath()));
                    clipPhoto(imageUri, PHOTO_REQUEST_CAMERA);//开始裁减图片
                }else {
                    clipPhoto(Uri.fromFile(new File(mImages.get(position).getPath())), PHOTO_REQUEST_CAMERA);//开始裁减图片
                }
//                clipPhoto(Uri.fromFile(new File(mImages.get(position).getPath())), PHOTO_REQUEST_CUT);//开始裁减图片
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                ...
                Uri imageUri = FileProvider.getUriForFile(ImageSelectActivity.this, "demo.mark.com.myimageselecter_demo.fileprovider", file);
            ...
            switch (requestCode) {
                ...
                case PHOTO_REQUEST_CUT:
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                        try {
                            //正对于华为荣耀系列的手机的修改假的判断
                            // 这 BitmapFactory.decodeStream(getContentResolver().openInputStream(uritempFile));会报错  空指针
                            if (uritempFile != null){
